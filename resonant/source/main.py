from resonant.source.initialization import OfflineAudioIter
from resonant.source.algorithms import SphereTester
if __name__ == "__main__":
    # Load audio file
    audio_iter = OfflineAudioIter('data/dog_barking_90_speech_270/combined.wav')
