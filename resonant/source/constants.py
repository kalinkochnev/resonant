...
NUM_MICS = 4
SAMPLING_RATE = 44100  # of samples taken per second for each channel
LOCALIZING_WINDOW = round(0.5 * SAMPLING_RATE) # This is the number of samples to run the algorithm on
# TODO not done
...
LARGE_WINDOW = 4 * SAMPLING_RATE #  # of seconds times sampling rate
